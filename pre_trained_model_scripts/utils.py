...
def get_attn_weights_numpy(model):
    weights_lst = [model.encoder.resblock1.seblock.get_weights(),
                   model.encoder.resblock2.seblock.weights.get_weights(),
                   model.encoder.resblock3.seblock.weights.get_weights(),
                   model.classifier.resblock1.seblock.weights.get_weights()]
    return weights_lst


def get_attn_weights(model):
    weights_lst = [model.encoder.resblock1.seblock.weights,
                   model.encoder.resblock2.seblock.weights,
                   model.encoder.resblock3.seblock.weights,
                   model.classifier.resblock1.seblock.weights]
    return weights_lst


def get_attn_trainable_weights(model):
    weights_lst = [model.encoder.resblock1.seblock.trainable_weights,
                   model.encoder.resblock2.seblock.trainable_weights,
                   model.encoder.resblock3.seblock.trainable_weights,
                   model.classifier.resblock1.seblock.trainable_weights]
    return weights_lst


def get_attn_non_trainable_weights(model):
    weights_lst = [model.encoder.resblock1.seblock.non_trainable_weights,
                   model.encoder.resblock2.seblock.non_trainable_weights,
                   model.encoder.resblock3.seblock.non_trainable_weights,
                   model.classifier.resblock1.seblock.non_trainable_weights]
    return weights_lst


#x = tf.random.uniform((1, 200, 1))
#y = model(x)
#print(model.encoder.resblock1.seblock.get_weights())
#print('-------------------------------------------------')
#print(model.encoder.resblock1.seblock.weights)
#print('-------------------------------------------------')
#print(model.encoder.resblock1.seblock.trainable_weights[0].numpy())
#print(model.encoder.resblock1.seblock.trainable)
#print('End -------------------------------------------------')
