...
ds_train = ds_train.shuffle(len(ds_train), seed=14, reshuffle_each_iteration=True)
...
tuner = kt.BayesianOptimization(
    ...
    max_trials=30,
    overwrite=True,
    directory="tmp/tb_attn2",
    project_name="hyper_attn")
...
tuner.search(
    ...
    callbacks=[tf.keras.callbacks.TensorBoard(log_dir="tmp/tb_logs_attn2")])
