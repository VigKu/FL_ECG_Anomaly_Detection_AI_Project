...
src = 'Datasets/'
df_train = pd.read_csv(src + 'train_mihbih_balance.csv')
df_val = pd.read_csv(src + 'val_mihbih.csv')
...
df_train_preproc['label'] = df_train[str(num_cols-1)]
save_as_csv(df=df_train_preproc, filename=f'Datasets/train_mihbih_preproc_sigma_{sigma}.csv')
...
df_val_preproc['label'] = df_val[str(num_cols-1)]
save_as_csv(df=df_val_preproc, filename=f'Datasets/val_mihbih_preproc_sigma_{sigma}.csv')
