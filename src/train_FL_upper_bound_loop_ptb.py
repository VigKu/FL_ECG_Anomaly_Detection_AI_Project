...
train_writer = tf.summary.create_file_writer("FL_logs/train/PTB_upper/")
val_writer = tf.summary.create_file_writer("FL_logs/val/PTB_upper/")
...
for i in range(0, 100, 4):
    if FIRST_EPOCH:
        ...
        keras_model.load_weights("saved_models/FL/model_ptb_upper.h5")
    ...
    for round_num in range(4):  # num_epochs
        ...
        if epoch % 1 == 0 or epoch == 2 - 1:
            ...
            eval_model.save_weights("saved_models/FL/model_ptb_upper.h5")
